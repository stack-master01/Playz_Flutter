...
class BookQRSport extends StatefulWidget {
  final String rawText;
  Map<String, dynamic> turfDetails = {};
  BookQRSport({super.key, required this.rawText, required this.turfDetails});

  @override
  State<BookQRSport> createState() => _BookQRSportState();
}

class _BookQRSportState extends State<BookQRSport> {
                      ...
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              Text(
                                _getTranslation("${currentTurfInfo['turf_name']}"), // 🌍 Translated
                                style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.w500,
                                  color: isDark
