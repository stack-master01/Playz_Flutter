...
class FriendChat extends StatefulWidget {
  ...
  FriendChat({super.key, required this.groupDataMap});
                          ...
                          Expanded(
                            child: StreamBuilder<List<Map<String, dynamic>>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final allFriendChats = snapshot.data!;

                                // 1. Process Timestamps and create chatCards (Your old loadAllChats logic)
                                List<Map<String, dynamic>> processedChats = [];

                                // This 'for' loop is CORRECT because allFriendChats is an Iterable (List)
                                for (var newItem in allFriendChats) {
