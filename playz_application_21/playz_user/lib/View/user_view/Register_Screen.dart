...
import 'package:playz_user/Model_Class/User_Model/User_Register_Model.dart';
...
class _UserRegisterScreenState extends State<UserRegisterScreen> {
  ...
  void _handleRegister() async {
    ...
    try {
      ...
      String password = "${_passwordController.text}Turf_User";
...
regObj['isBanned'] = false;
{
  ...
  regObj['createdAt'] = "${now.day}-${now.month}-${now.year}";
      ...
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          builder: (context) =>
              const NavigationSport(), // Change to your intended home screen
        ),
      );
                          ...
                          GestureDetector(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                ...
                                fontWeight: FontWeight.bold,
                                color:
                                    Reusable.getGreen(), // Highlighting the action link
                              ),
                            ),
                          ),
                        ],
  ...
  Widget _buildPasswordField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: Icon(Icons.lock_outline, color: Reusable.getGreen()),
        labelText: label,
        labelStyle: const TextStyle(color: Colors.black54),
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
