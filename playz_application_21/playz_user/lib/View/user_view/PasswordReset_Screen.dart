...
class UserPasswordResetScreen extends StatefulWidget {
 const UserPasswordResetScreen({super.key});

 @override
 State<UserPasswordResetScreen> createState() =>
   _ownerPasswordResetScreenState();
}

class _ownerPasswordResetScreenState extends State<UserPasswordResetScreen> {
 ...
 Widget build(BuildContext context) {
  final Color primaryColor = Reusable.getGreen();
