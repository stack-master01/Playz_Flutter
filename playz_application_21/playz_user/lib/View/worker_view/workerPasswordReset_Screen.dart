...
class WorkerPasswordResetScreen extends StatefulWidget {
  const WorkerPasswordResetScreen({super.key});

  @override
  State<WorkerPasswordResetScreen> createState() =>
      _WorkerPasswordResetScreenState();
}

class _WorkerPasswordResetScreenState extends State<WorkerPasswordResetScreen> {
