...
import 'package:playz_user/View/worker_view/workerPasswordReset_Screen.dart';

class WorkerForgotPasswordScreen extends StatefulWidget {
 const WorkerForgotPasswordScreen({super.key});

 @override
 State<WorkerForgotPasswordScreen> createState() =>
   _UserForgotPasswordScreenState();
}

class _UserForgotPasswordScreenState extends State<WorkerForgotPasswordScreen> {
 // --- OTP Logic Variables ---
 ...
 void _submitOtp() {
  if (_formKey.currentState!.validate()) {
   ...
   Navigator.of(context).pushReplacement(
    MaterialPageRoute(builder: (context) => const WorkerPasswordResetScreen()),
   );
  } else {
   ScaffoldMessenger.of(context).showSnackBar(
 ...
 Widget build(BuildContext context) {
  ...
  final Color primaryColor = Color.fromARGB(255, 109, 77, 65); 
