...
class WorkerWalkthroughScreen extends StatefulWidget {
  const WorkerWalkthroughScreen({super.key});

  @override
  State<WorkerWalkthroughScreen> createState() => _WorkerWalkthroughScreenState();
}

class _WorkerWalkthroughScreenState extends State<WorkerWalkthroughScreen> {
...
Color.fromARGB(255, 70, 45, 43),   // deep chocolate / dark brick
Color.fromARGB(255, 95, 60, 58),   // base rich reddish-brown
Color.fromARGB(255, 120, 75, 72),  // warm premium brick
                    ...
                    ElevatedButton(
                      ...
                      child: Text(
                        ...
                        style: const TextStyle(
                          ...
                          color: Color.fromARGB(255, 70, 45, 43),
                        ),
                      ),
                    ),
                  ],
  ...
  Widget _buildPageContent(int index) {
    final List<String> titles = [
      "Keep the Turf Match-Ready",
"Support Every Game & Player",
"Manage Operations Behind the Scenes"
    ];
    final List<String> subtitles = [
      "Maintain the fields, equipment, and facilities for flawless play!",
"Assist players, coaches, and events to ensure smooth games!",
"Coordinate cleaning, staff tasks, and daily turf operations efficiently!"
    ];
