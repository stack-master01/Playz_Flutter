...
class TrainerWalkthroughScreen extends StatefulWidget {
  const TrainerWalkthroughScreen({super.key});

  @override
  State<TrainerWalkthroughScreen> createState() => _TrainerWalkthroughScreenState();
}

class _TrainerWalkthroughScreenState extends State<TrainerWalkthroughScreen> {
...
Color.fromARGB(255, 180, 60, 10),
Color.fromARGB(255, 200, 70, 15),
Color.fromARGB(255, 220, 80, 20),
  ...
  Widget _buildPageContent(int index) {
    final List<String> titles = [
      "Train Athletes Across Every Sport",
"Grow Your Coaching Network",
"Track Progress and Build Champions"
    ];
    final List<String> subtitles = [
      "Offer expert coaching for gym workouts and popular sports!",
"Connect with fitness lovers, players, and trainers across different sports!",
"Monitor progress, set fitness goals, and help athletes achieve top performance!"
    ];
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            subtitles[index],
            style: const TextStyle(fontSize: 16, color: Color.fromARGB(255, 45, 40, 40)
),
            textAlign: TextAlign.center,
          ),
        ),
                ...
                child: AnimatedSwitcher(
                  ...
                  child: ClipRRect(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: Color.fromARGB(255, 234, 151, 126),   
               borderRadius: BorderRadius.circular(50),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black26,
