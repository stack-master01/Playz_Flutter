...
class OwnerWalkthroughScreen extends StatefulWidget {
  const OwnerWalkthroughScreen({super.key});

  @override
  State<OwnerWalkthroughScreen> createState() => _OwnerWalkthroughScreenState();
}

class _OwnerWalkthroughScreenState extends State<OwnerWalkthroughScreen> {
...
Color.fromARGB(255, 15, 60, 200),
Color.fromARGB(255, 30, 70, 220),
Color.fromARGB(255, 45, 100, 255),
  ];
...
"Easily Manage Turf Staff & Operations"
    ];
    final List<String> subtitles = [
      "Track bookings, payments, and profits — all in one place!",
"Connect with players, host leagues, and grow your local fan base!",
"Assign duties, monitor staff, and keep your turf running smoothly!"
    ];
