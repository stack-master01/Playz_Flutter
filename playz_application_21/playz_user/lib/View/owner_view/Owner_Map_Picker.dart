...
class OwnerMapPickerPage extends StatefulWidget {
  ...
  const OwnerMapPickerPage({super.key, required this.onLocationPicked});

  @override
  _OwnerMapPickerPageState createState() => _OwnerMapPickerPageState();
}
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<ThemeSettings>(
      ...
      builder: (context, settings, _) {
        ...
        Color blue = Color.fromRGBO(13, 71, 161, 1);
        return Scaffold(
          appBar: AppBar(
            leading: IconButton(
              onPressed: () {
            ...
            backgroundColor: isDark ? blue : blue,
          ),
                      ...
                      child: Column(
                        children: [
                          TextField(
                            ...
                            style: TextStyle(
                                color: isDark ? blue : Reusable.getDarkGrey()),
                            cursorColor: isDark ? blue : blue,
                            decoration: InputDecoration(
                              hintText: "Search by Name",
                              hintStyle: TextStyle(
                                  color: isDark ? blue : Reusable.getLightGrey()),
                              filled: true,
                              fillColor: isDark
